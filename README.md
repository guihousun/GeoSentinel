...
| Runtime limits | `NTL_MAX_ACTIVE_RUNS`, `NTL_MAX_ACTIVE_RUNS_PER_USER`, `NTL_MAX_LLM_CALLS_PER_RUN` (default `50`), `NTL_THREAD_WORKSPACE_QUOTA_MB`, `NTL_USER_WORKSPACE_QUOTA_MB` |
